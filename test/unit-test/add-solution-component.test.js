...
describe("Add solution component to target solution", function () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var addSolutionComponentStub;
    var credentials;
    beforeEach(function () {
        addSolutionComponentStub = (0, sinon_1.stub)();
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/add-solution-component/add-solution-component-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ addSolutionComponent: addSolutionComponentStub });
                    ...
                    case 1:
                        mockedModule = _a.sent();
                        return [4 /*yield*/, mockedModule.main()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it("calls add-solution-component action", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
