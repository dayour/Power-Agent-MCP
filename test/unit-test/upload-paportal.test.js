...
describe("upload paportal test", function () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var uploadPaportalStub;
    var credentials;
    beforeEach(function () {
        uploadPaportalStub = (0, sinon_1.stub)();
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/upload-paportal/upload-paportal-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ uploadPaportal: uploadPaportalStub });
    ...
    it("calls upload paportal", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
