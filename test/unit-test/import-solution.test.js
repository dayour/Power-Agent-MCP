...
describe("import-solution tests", function () {
    var importSolutionStub;
    var credentials;
    beforeEach(function () {
        importSolutionStub = (0, sinon_1.stub)();
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/import-solution/import-solution-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ importSolution: importSolutionStub });
    ...
    it("fetches parameters from index.ts, calls importSolutionStub properly", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
