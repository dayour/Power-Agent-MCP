...
describe("create-environment tests", function () {
    var createEnvironmentStub;
    var credentials;
    beforeEach(function () {
        createEnvironmentStub = (0, sinon_1.stub)().returns({
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/create-environment/create-environment-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ createEnvironment: createEnvironmentStub });
    ...
    it("fetches parameters from index.ts, calls createEnvironmentStub properly", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
