...
describe("unpack solution test", function () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var unpackSolutionStub;
    beforeEach(function () {
        unpackSolutionStub = (0, sinon_1.stub)();
    });
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/unpack-solution/unpack-solution-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ unpackSolution: unpackSolutionStub });
                        })];
                    case 1:
                        unpack = _a.sent();
                        unpack.main();
    ...
    it("calls unpack solution", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
