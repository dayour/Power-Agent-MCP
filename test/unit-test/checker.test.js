...
describe("check solution test", function () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var checkSolutionStub;
    var credentials;
    beforeEach(function () {
        checkSolutionStub = (0, sinon_1.stub)();
        credentials = (0, ts_sinon_1.stubInterface)();
    });
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/checker/checker-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ checkSolution: checkSolutionStub });
                            mock(function () { return Promise.resolve().then(function () { return require("../../src/params/auth/getCredentials"); }); }).with({ getCredentials: function () { return credentials; } });
                            mock(function () { return Promise.resolve().then(function () { return require('../../src/params/auth/getEnvironmentUrl'); }); }).with({ readEnvUrlFromServiceConnection: function () { return mockData_1.mockEnvironmentUrl; } });
                        })];
                    case 1:
                        checker = _a.sent();
                        return [4 /*yield*/, checker.main()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it("calls check solution", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    checkSolutionStub.should.have.been.calledOnceWithExactly({
                        ...
                        environmentUrl: mockData_1.mockEnvironmentUrl,
                        ...
                        logToConsole: false
                    }, new BuildToolsRunnerParams_1.BuildToolsRunnerParams(), new BuildToolsHost_1.BuildToolsHost('PowerAppsChecker'));
                    return [2 /*return*/];
            }
        });
    }); });
