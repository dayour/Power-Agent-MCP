...
describe("Assign group to target environment", function () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var assignGroupStub;
    var credentials;
    beforeEach(function () {
        assignGroupStub = (0, sinon_1.stub)();
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/assign-group/assign-group-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ assignGroup: assignGroupStub });
    ...
    it("calls assign group action", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
