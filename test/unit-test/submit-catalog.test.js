...
describe("submit-catalog tests", function () {
    var submitCatalogStub;
    var credentials;
    beforeEach(function () {
        submitCatalogStub = (0, sinon_1.stub)();
    ...
    function callActionWithMocks() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, rewiremock_1.default.around(function () { return Promise.resolve().then(function () { return require("../../src/tasks/submit-catalog/submit-catalog-v2/index"); }); }, function (mock) {
                            mock(function () { return Promise.resolve().then(function () { return require("@microsoft/powerplatform-cli-wrapper/dist/actions"); }); }).with({ submitCatalog: submitCatalogStub });
    ...
    it("fetches parameters from index.ts, calls submitCatalogStub properly", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
