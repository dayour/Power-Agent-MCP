...
export class ParameterValidator {
     ...
     */
    static validateSolutionPath(inputPath) {
        if (!inputPath) {
            return {
                isValid: false,
     ...
     * @returns ValidationResult with detailed feedback
     */
    static validateEnvironmentUrl(environmentUrl) {
        if (!environmentUrl) {
            return {
                isValid: false,
     ...
     * @returns ValidationResult with detailed feedback
     */
    static validateSolutionName(solutionName) {
        if (!solutionName) {
            return {
                isValid: false,
     ...
     */
    static validateAndThrow(params) {
        const { solutionName, solutionPath, environmentUrl } = params;
        if (solutionName) {
            const nameValidation = this.validateSolutionName(solutionName);
            if (!nameValidation.isValid) {
                ErrorHandler.handleValidationError('SolutionName', solutionName, nameValidation.message, nameValidation.suggestion ? [nameValidation.suggestion] : undefined);
        ...
        if (solutionPath) {
            ...
            if (!pathValidation.isValid) {
                ErrorHandler.handleValidationError('SolutionPath', solutionPath, pathValidation.message, pathValidation.suggestion ? [pathValidation.suggestion] : undefined);
                return;
            }
        }
        if (environmentUrl) {
            ...
            if (!urlValidation.isValid) {
                ErrorHandler.handleValidationError('EnvironmentUrl', environmentUrl, urlValidation.message, urlValidation.suggestion ? [urlValidation.suggestion] : undefined);
                return;
            }
        }
    }
