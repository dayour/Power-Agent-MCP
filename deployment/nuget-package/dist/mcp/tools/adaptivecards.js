...
export class AdaptiveCardTools {
    ...
    getHandlers() {
        return {
            ...
            pp_adaptivecard_create: async (args) => this.createAdaptiveCard(args),
            pp_adaptivecard_validate: async (args) => this.validateAdaptiveCard(args),
            pp_adaptivecard_generate_from_data: async (args) => this.generateFromData(args),
            pp_adaptivecard_deploy_to_copilot: async (args) => this.deployToCopilot(args),
            pp_adaptivecard_list_templates: async (args) => this.listTemplates(args),
            pp_adaptivecard_convert_legacy: async (args) => this.convertLegacyCard(args),
            pp_adaptivecard_test_rendering: async (args) => this.testRendering(args),
            pp_adaptivecard_extract_from_copilot: async (args) => this.extractFromCopilot(args),
            pp_adaptivecard_data_binding: async (args) => this.configureDataBinding(args)
        };
    }
    ...
    async validateAdaptiveCard(args) {
    ...
    async listTemplates(args) {
        ...
        const filteredTemplates = category === 'all' ? templates : { [category]: templates[category] };
        return {
            success: true,
            data: {
                category,
    ...
    async testRendering(args) {
        ...
        return {
            ...
            data: {
                ...
                renderingResults: {
                    compatible: true,
                    supportedFeatures: hostCapabilities[hostApp]?.supportsActions || [],
                    limitations: hostCapabilities[hostApp]?.limitations || [],
                    recommendations: hostCapabilities[hostApp]?.recommendations || []
                },
    ...
    async configureDataBinding(args) {
