...
export class EnvironmentTools {
    ...
    getHandlers() {
        return {
            ...
            pp_admin_add_group: async (args) => ({ content: `Environment ${args.environment} added to group: ${args.groupId}` }),
            pp_admin_list_applications: async () => ({ content: 'Microsoft Entra ID applications listed' }),
            pp_admin_register_application: async (args) => ({ content: `Application registered: ${args.name}` }),
            pp_admin_unregister_application: async (args) => ({ content: `Application unregistered: ${args.applicationId}` }),
            pp_admin_create_service_principal: async (args) => ({ content: `Service principal created for application: ${args.applicationId}` }),
            ...
            pp_admin_list_backups: async (args) => ({ content: `Backups listed for environment: ${args.environment}` }),
            ...
            pp_admin_set_backup_retention: async (args) => ({ content: `Backup retention set to ${args.retentionPeriod} days for: ${args.environment}` }),
            pp_admin_set_runtime_state: async (args) => ({ content: `Runtime state set to ${args.runtimeState} for: ${args.environment}` }),
