...
export async function main() {
    ...
    try {
        ...
        ParameterValidator.validateAndThrow({
            solutionName: solutionName?.defaultValue,
            solutionPath: outputPath?.defaultValue,
        ...
        ErrorHandler.handleSolutionExportError(solutionName?.defaultValue || 'Unknown', environmentUrl, outputPath?.defaultValue, error instanceof Error ? error : String(error));
    }
}
