...
export function SetTaskOutputVariable(varName, value) {
    tl.setVariable(varName, value, false, true);
}
export function GetPipelineVariable(varName) {
    let value;
    if (hasTaskVars) {
...
export function GetPipelineOutputVariable(varName) {
    let envParams = {
        value: undefined,
        taskName: undefined
    };
...
export function IsolateVariableReference(refExpression) {
