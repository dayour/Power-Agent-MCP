...
var QualityTools = /** @class */ (function () {
    function QualityTools() {
    }
    QualityTools.prototype.getTools = function () {
        return [
            {
    ...
    QualityTools.prototype.getHandlers = function () {
        return {
            pp_solution_checker: this.runSolutionChecker.bind(this)
        };
    };
    QualityTools.prototype.runSolutionChecker = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var checkerMain, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('../../tasks/checker/checker-v2/index.js'); })];
                    case 1:
                        checkerMain = (_a.sent()).main;
                    ...
                    case 4:
                        error_1 = _a.sent();
                        throw new Error("Failed to run solution checker: ".concat(error_1 instanceof Error ? error_1.message : String(error_1)));
