...
export class CopilotTools {
  ...
  getHandlers(): Record<string, (args: any) => Promise<any>> {
    return {
      ...
      // Creation & Cloning Category
      pp_copilot_clone: async (args: any) => {
