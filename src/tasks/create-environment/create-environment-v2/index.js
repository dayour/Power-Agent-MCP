...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskParser, parameterMap, isDiagnosticsMode, environmentName, createResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, actions_1.createEnvironment)({
                ...
                case 2:
                    ...
                    if (!createResult.environmentUrl || !createResult.environmentId) {
                        return [2 /*return*/, tl.setResult(tl.TaskResult.SucceededWithIssues, 'CreateEnvironment call did NOT return the expected environment URL!')];
                    }
                    // set output variables:
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvUrlVariableName, createResult.environmentUrl);
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvIdVariableName, createResult.environmentId);
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    // Enhanced error handling for environment creation
                    ErrorHandler_1.ErrorHandler.handleEnvironmentError("create environment '".concat((environmentName === null || environmentName === void 0 ? void 0 : environmentName.defaultValue) || 'Unknown', "'"), 'N/A', // No specific environment URL for creation
                    error_1 instanceof Error ? error_1 : String(error_1));
                    return [3 /*break*/, 4];
