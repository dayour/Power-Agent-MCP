...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskParser, parameterMap, defaultAuthType, isDiagnosticsMode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    taskParser = new TaskParser_1.TaskParser();
                    parameterMap = taskParser.getHostParameterEntries(taskDefinitionData);
                    defaultAuthType = 'PowerPlatformSPN';
                    isDiagnosticsMode = tl.getVariable('agent.diagnostic');
                    return [4 /*yield*/, (0, actions_1.checkSolution)({
                            // PS impl only supported single auth mode, SPN; some pipelines have no explicit value for authenticationType
                            credentials: (0, getCredentials_1.getCredentials)(defaultAuthType),
                            environmentUrl: (0, getEnvironmentUrl_1.readEnvUrlFromServiceConnection)(defaultAuthType),
