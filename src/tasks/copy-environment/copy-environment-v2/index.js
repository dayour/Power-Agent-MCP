...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskParser, parameterMap, isDiagnosticsMode, copyResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, actions_1.copyEnvironment)({
                ...
                case 1:
                    ...
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvUrlVariableName, copyResult.environmentUrl);
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvIdVariableName, copyResult.environmentId);
                    return [2 /*return*/];
            }
        });
    });
