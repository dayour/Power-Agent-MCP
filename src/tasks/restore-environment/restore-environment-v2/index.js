...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskParser, parameterMap, isDiagnosticsMode, restoreResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, actions_1.restoreEnvironment)({
                ...
                case 1:
                    ...
                    if (!restoreResult.environmentUrl || !restoreResult.environmentId) {
                        return [2 /*return*/, tl.setResult(tl.TaskResult.SucceededWithIssues, 'CopyEnvironment call did NOT return the expected environment URL!')];
                    }
                    // set output variables:
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvUrlVariableName, restoreResult.environmentUrl);
                    (0, PipelineVariables_1.SetTaskOutputVariable)(PipelineVariables_1.EnvIdVariableName, restoreResult.environmentId);
                    return [2 /*return*/];
            }
        });
    });
