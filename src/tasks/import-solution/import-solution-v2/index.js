...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var taskParser, parameterMap, publishWorkflows, activatePlugins, activatePluginsMerged, isDiagnosticsMode, solutionPath, environmentUrl, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    taskParser = new TaskParser_1.TaskParser();
                    parameterMap = taskParser.getHostParameterEntries(taskDefinitionData);
                    publishWorkflows = tl.getInput("PublishWorkflows", false);
                    activatePlugins = tl.getInput("ActivatePlugins", false);
                    activatePluginsMerged = publishWorkflows === 'true' || activatePlugins === 'true';
                    isDiagnosticsMode = tl.getVariable('agent.diagnostic');
                    solutionPath = parameterMap['SolutionInputFile'];
                ...
                case 1:
                    ...
                    ParameterValidator_1.ParameterValidator.validateAndThrow({
                        solutionPath: solutionPath === null || solutionPath === void 0 ? void 0 : solutionPath.defaultValue,
                        environmentUrl: environmentUrl
                    });
                    return [4 /*yield*/, (0, actions_1.importSolution)({
                ...
                case 3:
                    ...
                    ErrorHandler_1.ErrorHandler.handleSolutionImportError((solutionPath === null || solutionPath === void 0 ? void 0 : solutionPath.defaultValue) || 'Unknown', environmentUrl, error_1 instanceof Error ? error_1 : String(error_1));
                    return [3 /*break*/, 4];
