...
export class TaskParser {
   ...
   */
  private validateTaskDefinition(data: any): AzurePipelineTaskDefiniton {
   ...
   */
  public getParameter(
    parameterMap: Record<string, HostParameterEntry>,
    parameterName: string
  ): HostParameterEntry | undefined {
   ...
   */
  public getParameterValue<T = any>(
    parameterMap: Record<string, HostParameterEntry>,
    parameterName: string,
    fallback?: T
  ): T {
    ...
    return (parameter.defaultValue as T) ?? fallback;
  }
   ...
   */
  public validateRequiredParameters(
    parameterMap: Record<string, HostParameterEntry>,
